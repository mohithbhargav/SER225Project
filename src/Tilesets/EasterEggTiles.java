...
public class EasterEggTiles extends Tileset {

    public EasterEggTiles() {
    ...
    public ArrayList<MapTileBuilder> defineTiles() {
         ...
         * .build();
         * 
         * MapTileBuilder treeTrunkWithFullHoleTile = new
         * MapTileBuilder(treeTrunkWithFullHoleFrame)
         * .withTileType(TileType.NOT_PASSABLE);
         * 
         ...
         * .build();
         * 
         * MapTileBuilder treeTrunkHoleTopTile = new
         * MapTileBuilder(treeTrunkHoleTopFrame)
         * .withTileType(TileType.NOT_PASSABLE);
         * 
         ...
         * .build();
         * 
         * MapTileBuilder treeTrunkHoleBottomTile = new
         * MapTileBuilder(treeTrunkHoleBottomFrame)
         * .withTileType(TileType.NOT_PASSABLE);
         * 
         ...
         * .build();
         * 
         * MapTileBuilder leftStairsBottomTile = new
         * MapTileBuilder(leftStairsBottomFrame)
         * .withTileType(TileType.SLOPE)
         * .withTileLayout(SlopeTileLayoutUtils.createBottomLeft30SlopeLayout(
         * spriteWidth, (int) tileScale));
         * 
