...
public class GuardB extends Enemy {
    ...
    public GuardB(Point startLocation, Point endLocation, Direction facingDirection) {
        super(startLocation.x, startLocation.y, new SpriteSheet(ImageLoader.load("BGuard.png"), 26, 30), "WALK_RIGHT");
